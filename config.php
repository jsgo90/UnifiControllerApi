 ...
 */
$controlleruser     = 'usuario'; // the user name for access to the UniFi Controller
$controllerpassword = 'password'; // the password for access to the UniFi Controller
$controllerurl      = 'https://HOST:8443'; // full url to the UniFi Controller, eg. 'https://22.22.11.11:8443'
